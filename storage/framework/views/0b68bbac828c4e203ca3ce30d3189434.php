...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2">
            <!-- Export Excel -->
            <a href="<?php echo e(route('export.surat-masuk.excel', request()->query())); ?>" 
            ...
            <!-- Export PDF -->
            <a href="<?php echo e(route('export.surat-masuk.pdf', request()->query())); ?>" target="_blank"
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-5">
        <form method="GET" action="<?php echo e(route('surat-masuk.index')); ?>" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 items-center">
            ...
            <div class="lg:col-span-1 flex gap-1.5">
                ...
                <?php if(request()->anyFilled(['search', 'kategori_id', 'status', 'dari_tanggal'])): ?>
                    <a href="<?php echo e(route('surat-masuk.index')); ?>" title="Reset Filter" 
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__empty_1 = true; $__currentLoopData = $suratMasuks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-slate-50/80 transition duration-150">
                        <td class="px-5 py-4 font-bold text-blue-600 whitespace-nowrap">#<?php echo e($s->nomor_agenda); ?></td>
                        <td class="px-5 py-4 font-semibold text-slate-800 whitespace-nowrap"><?php echo e($s->nomor_surat); ?></td>
                        <td class="px-5 py-4 text-slate-500 whitespace-nowrap"><?php echo e(optional($s->tanggal_terima)->format('d/m/Y') ?? '-'); ?></td>
                        <td class="px-5 py-4 text-slate-700">
                            <span class="inline-block px-2.5 py-1 rounded-lg bg-slate-100 border border-slate-200 text-xs font-medium">
                                <?php echo e($s->instansi->nama_instansi ?? '-'); ?>
                        ...
                        <td class="px-5 py-4 whitespace-nowrap">
                            ...
                            <span class="inline-block px-2.5 py-1 rounded-full text-xs font-semibold border <?php echo e($badgeClass); ?>">
                                <?php echo e(ucfirst($s->status ?? 'Baru')); ?>

                            </span>
                        </td>
                        <td class="px-5 py-4 text-center whitespace-nowrap">
                            <div class="inline-flex items-center gap-1">
                                <a href="<?php echo e(route('surat-masuk.show', $s)); ?>" class="p-1.5 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition" title="Lihat Detail">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                </a>
                                <a href="<?php echo e(route('surat-masuk.edit', $s)); ?>" class="p-1.5 text-slate-400 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition" title="Ubah Data">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                </a>
                                <a href="<?php echo e(route('disposisi.create', $s)); ?>" class="p-1.5 text-slate-400 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition" title="Buat Disposisi">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>
                                </a>
                                <form action="<?php echo e(route('surat-masuk.destroy', $s)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?> 
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="button" 
                                            onclick="confirmDelete(event, 'Surat Masuk <?php echo e($s->nomor_surat); ?> akan dihapus secara permanen!')" 
        ...
        <!-- PAGINATION FOOTER -->
        <?php if(isset($suratMasuks) && method_exists($suratMasuks, 'hasPages') && $suratMasuks->hasPages()): ?>
            <div class="px-5 py-4 border-t border-slate-100">
                <?php echo e($suratMasuks->withQueryString()->links()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Downloads\E-Arsip\resources\views/surat_masuk/index.blade.php ENDPATH**/ ?>