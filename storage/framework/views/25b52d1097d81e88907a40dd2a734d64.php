<?php $__env->startSection('title', 'Ubah Surat Masuk'); ?>
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Ubah Surat Masuk</h1>
            <p class="text-sm text-slate-500 mt-0.5">Perbarui data arsip surat masuk dan informasi lokasi berkas fisik.</p>
        </div>
    ...
    <form method="POST" action="<?php echo e(route('surat-masuk.update', $suratMasuk)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?> 
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 overflow-hidden">
            ...
            <div class="bg-blue-50/70 border-b border-blue-100 px-6 py-4 flex items-center justify-between">
                <div class="flex items-center text-blue-900 text-sm">
                    ...
                    <span class="font-medium">Nomor agenda: <strong class="font-semibold text-blue-700 font-mono bg-blue-100/80 px-2.5 py-1 rounded-lg ml-1 text-xs border border-blue-200/60"><?php echo e($suratMasuk->nomor_agenda); ?></strong></span>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_surat" value="<?php echo e(old('nomor_surat', $suratMasuk->nomor_surat)); ?>" required placeholder="Masukkan nomor surat"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="instansi_id" required class="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3.5 py-2.5 text-sm text-slate-700 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none transition duration-150 font-medium <?php $__errorArgs = ['instansi_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                                <?php $__currentLoopData = $instansis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($i->id); ?>" <?php if(old('instansi_id', $suratMasuk->instansi_id) == $i->id): echo 'selected'; endif; ?>><?php echo e($i->nama_instansi); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_surat" value="<?php echo e(old('tanggal_surat', is_string($suratMasuk->tanggal_surat) ? $suratMasuk->tanggal_surat : optional($suratMasuk->tanggal_surat)->format('Y-m-d'))); ?>" required
                                class="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3.5 py-2.5 text-sm text-slate-700 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none transition duration-150 font-medium <?php $__errorArgs = ['tanggal_surat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_terima" value="<?php echo e(old('tanggal_terima', is_string($suratMasuk->tanggal_terima) ? $suratMasuk->tanggal_terima : optional($suratMasuk->tanggal_terima)->format('Y-m-d'))); ?>" required
                                class="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3.5 py-2.5 text-sm text-slate-700 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none transition duration-150 font-medium <?php $__errorArgs = ['tanggal_terima'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="kategori_surat_id" required class="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3.5 py-2.5 text-sm text-slate-700 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none transition duration-150 font-medium <?php $__errorArgs = ['kategori_surat_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($k->id); ?>" <?php if(old('kategori_surat_id', $suratMasuk->kategori_surat_id) == $k->id): echo 'selected'; endif; ?>><?php echo e($k->nama_kategori); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="status" required class="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3.5 py-2.5 text-sm text-slate-700 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none transition duration-150 font-medium <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                <?php $__currentLoopData = ['baru','diproses','didisposisikan','selesai','diarsipkan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($st); ?>" <?php if(old('status', strtolower($suratMasuk->status ?? '')) == $st): echo 'selected'; endif; ?>><?php echo e(ucfirst($st)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('perihal', $suratMasuk->perihal)); ?></textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1.5">
                                ...
                                <?php if($suratMasuk->lampiran_file): ?>
                                    <a href="<?php echo e(route('lampiran.preview', $suratMasuk->lampiran_file)); ?>" target="_blank" class="inline-flex items-center text-xs font-semibold text-blue-600 hover:text-blue-800 bg-blue-50 hover:bg-blue-100 border border-blue-200/80 px-2.5 py-1 rounded-lg transition">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="lokasi_arsip_fisik" value="<?php echo e(old('lokasi_arsip_fisik', $suratMasuk->lokasi_arsip_fisik)); ?>" placeholder="Contoh: Rak A-3 Box 12"
                                class="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3.5 py-2.5 text-sm text-slate-700 placeholder-slate-400 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none transition duration-150 <?php $__errorArgs = ['lokasi_arsip_fisik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Downloads\E-Arsip\resources\views/surat_masuk/edit.blade.php ENDPATH**/ ?>