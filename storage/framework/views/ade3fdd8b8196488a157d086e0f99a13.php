...
<?php $__env->startSection('title', 'Detail Disposisi'); ?>
...
<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="<?php echo e(route('disposisi.edit', $disposisi)); ?>" class="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-xl text-xs font-semibold transition inline-flex items-center gap-2 shadow-sm">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-6 space-y-6">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
            <div>
                ...
                <span class="inline-block mt-1 px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-800">
                    <?php echo e(ucfirst($disposisi->status ?? 'menunggu')); ?>
            ...
            <div>
                ...
                ?>
                <span class="inline-block mt-1 px-3 py-1 rounded-full text-xs font-semibold border <?php echo e($sifatClass); ?>">
                    <?php echo e(ucfirst($disposisi->sifat ?? 'Biasa')); ?>
            ...
            <div>
                ...
                <span class="text-sm font-semibold text-slate-700 block mt-1">
                    <?php echo e(optional($disposisi->batas_waktu)->format('d F Y') ?? ($disposisi->batas_waktu ? \Carbon\Carbon::parse($disposisi->batas_waktu)->format('d F Y') : '-')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <div class="mt-1">
                    <?php if($disposisi->suratMasuk): ?>
                        <a href="<?php echo e(route('surat-masuk.show', $disposisi->suratMasuk)); ?>" class="text-blue-600 hover:underline font-bold text-base inline-flex items-center gap-1.5">
                            <span>#<?php echo e($disposisi->suratMasuk->nomor_agenda); ?></span>
                            <span class="text-sm text-slate-500 font-normal">(<?php echo e($disposisi->suratMasuk->nomor_surat ?? '-'); ?>)</span>
                        </a>
                    <?php else: ?>
            ...
            <div>
                ...
                <p class="mt-1 text-sm font-semibold text-slate-700">
                    <?php echo e(optional($disposisi->tanggal_disposisi)->format('d F Y') ?? ($disposisi->tanggal_disposisi ? \Carbon\Carbon::parse($disposisi->tanggal_disposisi)->format('d F Y') : '-')); ?>
            ...
            <div>
                ...
                <p class="mt-1 text-sm font-semibold text-slate-700">
                    <?php echo e($disposisi->dari->name ?? '-'); ?>
            ...
            <div>
                ...
                <p class="mt-1 text-sm font-semibold text-slate-700">
                    <?php echo e($disposisi->kepada->name ?? $disposisi->tujuan ?? $disposisi->penerima ?? '-'); ?>
        ...
        <div>
            ...
            <div class="mt-2 p-4 bg-slate-50 rounded-xl border border-slate-200/60 text-slate-700 text-sm leading-relaxed whitespace-pre-line">
                <?php echo e($disposisi->isi_disposisi ?? $disposisi->catatan ?? 'Tidak ada catatan instruksi.'); ?>
