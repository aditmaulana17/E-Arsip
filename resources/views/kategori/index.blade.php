...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200/80 p-4">
        <form method="GET" action="{{ route('kategori.index') }}" class="flex flex-col sm:flex-row items-center gap-3">
            ...
            <div class="flex items-center gap-2 w-full sm:w-auto">
                ...
                @if(request()->filled('search'))
                    <a href="{{ route('kategori.index') }}" class="px-3 py-2 bg-slate-100 text-slate-600 rounded-lg text-sm font-medium hover:bg-slate-200 transition-colors border border-slate-200">
                        Reset
                    </a>
                @endif
            </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="px-5 py-4">
                            ...
                            @if($k->keterangan)
                                <div class="text-xs text-slate-400 truncate max-w-xs mt-0.5" title="{{ $k->keterangan }}">{{ $k->keterangan }}</div>
                            @endif
                        </td>
                        ...
                        <td class="px-5 py-4 whitespace-nowrap">
                            ...
                            @endphp
                            <span class="text-xs font-semibold px-2.5 py-1 rounded-full border {{ $sifatClass }}">
                        ...
                        <td class="px-5 py-4 text-right whitespace-nowrap">
                            <div class="inline-flex items-center gap-1">
                                ...
                                <form action="{{ route('kategori.destroy', $k) }}" method="POST" class="inline">
                                    ...
                                    @method('DELETE')
                                    <button type="button" 
                                            onclick="confirmDelete(event, 'Kategori {{ $k->nama_kategori }} akan dihapus secara permanen!')" 
        ...
        <form method="POST" action="{{ route('kategori.update', $k) }}">
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="nama_kategori" value="{{ $k->nama_kategori }}" required class="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-sm text-slate-800 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="kode" value="{{ $k->kode }}" required class="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-sm font-mono text-slate-800 uppercase focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="keterangan" rows="3" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-sm text-slate-800 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all resize-none">{{ $k->keterangan }}</textarea>
                </div>
            </div>
