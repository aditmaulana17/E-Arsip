    ...
    <aside 
        ...
        <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
            <a href="{{ route('dashboard') }}" 
               title="Dashboard"
               class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/30 font-semibold' : 'hover:bg-slate-800 hover:text-white text-slate-400' }}">
            ...
            <a href="{{ route('surat-masuk.index') }}" 
               title="Surat Masuk"
               class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('surat-masuk.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/30 font-semibold' : 'hover:bg-slate-800 hover:text-white text-slate-400' }}">
            ...
            <a href="{{ route('surat-keluar.index') }}" 
               title="Surat Keluar"
               class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('surat-keluar.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/30 font-semibold' : 'hover:bg-slate-800 hover:text-white text-slate-400' }}">
            ...
            <a href="{{ route('disposisi.index') }}" 
               title="Disposisi"
               class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('disposisi.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/30 font-semibold' : 'hover:bg-slate-800 hover:text-white text-slate-400' }}">
            ...
            @if(auth()->user()?->isAdmin() || auth()->user()?->role === 'admin')
                ...
                <a href="{{ route('kategori.index') }}" 
                   ...
                   class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('kategori.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/30 font-semibold' : 'hover:bg-slate-800 hover:text-white text-slate-400' }}">
                ...
                <a href="{{ route('instansi.index') }}" 
                   title="Instansi"
                   class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('instansi.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/30 font-semibold' : 'hover:bg-slate-800 hover:text-white text-slate-400' }}">
                ...
                <a href="{{ route('users.index') }}" 
                   title="Pengguna"
                   class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('users.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/30 font-semibold' : 'hover:bg-slate-800 hover:text-white text-slate-400' }}">
        ...
        <div class="p-4 border-t border-slate-800 text-center text-xs text-slate-500 font-medium whitespace-nowrap">
            <span data-sidebar-label>E-Arsip &copy; {{ date('Y') }}</span>
