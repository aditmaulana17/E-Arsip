    ...
    <aside 
        ...
        <nav class="flex-1 px-3 py-5 space-y-1.5 overflow-y-auto">
            <a href="{{ route('dashboard') }}" 
               title="Dashboard"
               class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30' : 'hover:bg-zinc-800/80 hover:text-white text-zinc-400' }}">
            ...
            <a href="{{ route('surat-masuk.index') }}" 
               title="Surat Masuk"
               class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->routeIs('surat-masuk.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30' : 'hover:bg-zinc-800/80 hover:text-white text-zinc-400' }}">
            ...
            <a href="{{ route('surat-keluar.index') }}" 
               title="Surat Keluar"
               class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->routeIs('surat-keluar.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30' : 'hover:bg-zinc-800/80 hover:text-white text-zinc-400' }}">
            ...
            <a href="{{ route('disposisi.index') }}" 
               title="Disposisi"
               class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->routeIs('disposisi.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30' : 'hover:bg-zinc-800/80 hover:text-white text-zinc-400' }}">
            ...
            @if(auth()->user()?->isAdmin() || auth()->user()?->role === 'admin')
                ...
                <a href="{{ route('kategori.index') }}" 
                   ...
                   class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->routeIs('kategori.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30' : 'hover:bg-zinc-800/80 hover:text-white text-zinc-400' }}">
                ...
                <a href="{{ route('instansi.index') }}" 
                   title="Instansi"
                   class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->routeIs('instansi.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30' : 'hover:bg-zinc-800/80 hover:text-white text-zinc-400' }}">
                ...
                <a href="{{ route('users.index') }}" 
                   title="Pengguna"
                   class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->routeIs('users.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30' : 'hover:bg-zinc-800/80 hover:text-white text-zinc-400' }}">
