...
<div class="max-w-4xl mx-auto space-y-4 sm:space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-slate-800 tracking-tight">Catat Surat Masuk</h1>
            <p class="text-xs sm:text-sm text-slate-500 mt-0.5">Isi formulir di bawah ini untuk menambahkan data arsip surat masuk baru.</p>
        </div>
    ...
    @if ($errors->any())
        <div class="p-4 bg-rose-50 border border-rose-200 rounded-xl">
            <p class="text-xs font-bold text-rose-700 uppercase tracking-wider mb-1">Gagal Menyimpan Surat:</p>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 overflow-hidden">
            ...
            <div class="bg-blue-50/70 border-b border-blue-100 px-4 sm:px-6 py-3.5 flex items-center justify-between">
                <div class="flex items-center text-blue-900 text-xs sm:text-sm">
                    ...
                    <span class="font-medium">Nomor agenda otomatis: <strong class="font-semibold text-blue-700 font-mono bg-blue-100/80 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg ml-1 text-xs border border-blue-200/60">#{{ $nomorAgenda }}</strong></span>
                </div>
            </div>
