        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 overflow-hidden">
            ...
            <div class="bg-blue-50/70 border-b border-blue-100 px-6 py-4 flex items-center justify-between">
                <div class="flex items-center text-blue-900 text-sm">
                    ...
                    <span class="font-medium">Nomor agenda: <strong class="font-semibold text-blue-700 font-mono bg-blue-100/80 px-2.5 py-1 rounded-lg ml-1 text-xs border border-blue-200/60">{{ $suratMasuk->nomor_agenda }}</strong></span>
                </div>
            </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1.5">
                                ...
                                @if($suratMasuk->lampiran_file)
                                    <a href="{{ route('lampiran.preview', $suratMasuk->lampiran_file) }}" target="_blank" class="inline-flex items-center text-xs font-semibold text-blue-600 hover:text-blue-800 bg-blue-50 hover:bg-blue-100 border border-blue-200/80 px-2.5 py-1 rounded-lg transition">
